...
/**
 * Emite un <b>back-channel logout token</b> (OIDC RFC 8417): un JWT firmado con la clave de
 ...
 * </ul>
 * Sin {@code aud}, sin {@code nonce} (RFC 8417 §2.4).
 */
@Component
public class BackChannelLogoutTokenIssuer {
    ...
    public Jwt issue(String issuer, String subject) {
